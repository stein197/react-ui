...
/**
 * Adds and automatically removes event listeners from the element.
 * @param element Element to add event listener to.
 * @param type Event type.
 * @param listener Event listener. It's better to pass a callback from {@link React.useCallback()} instead of a raw one.
 * @param options Event listener options.
 */
export function useEventListener<T extends HTMLElement, K extends keyof HTMLElementEventMap>(element: T, type: K, listener: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
 ...
 * @param options Event listener options.
 */
export function useEventListener<T extends SVGElement, K extends keyof SVGElementEventMap>(element: T, type: K, listener: (this: SVGElement, ev: SVGElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
 ...
 * @param options Event listener options.
 */
export function useEventListener<T extends MathMLElement, K extends keyof MathMLElementEventMap>(element: T, type: K, listener: (this: MathMLElement, ev: MathMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
 ...
 * @param options Event listener options.
 */
export function useEventListener(element: Element, type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
